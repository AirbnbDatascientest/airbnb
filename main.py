...
with dataset:
	df = pd.read_csv("airbnb.csv", engine="python", sep=';', quotechar='"', error_bad_lines=False)
	st.write(df.head())
	df_paris= pd.read_csv("airbnb_paris.csv", engine="python", sep=';', quotechar='"', error_bad_lines=False)
	df_london= pd.read_csv("airbnb_london.csv", engine="python", sep=';', quotechar='"', error_bad_lines=False)
